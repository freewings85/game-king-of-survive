...
export class V03BattleDirector extends Component {
  ...
  private renderStatus(): void {
    ...
    const visualStats = this.visualStats
      ? `G${this.visualStats.heroGear} V${this.visualStats.zombieVariants} D${this.visualStats.unitDecals} PG${this.visualStats.propGroundLayers} PW${this.visualStats.propWearDecals} PS${this.visualStats.propShapeBlocks} FX${this.visualStats.fxLayers}`
      : 'visual pending';
