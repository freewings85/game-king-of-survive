...
| Clear class/skin/skill visuals | `frontend/engine-demo/app.js`, `frontend/engine-demo/index.html`, `frontend/engine-demo/assets/portraits/class-focus-guardian.png`, `frontend/engine-demo/assets/portraits/class-focus-tech.png`, `frontend/engine-demo/assets/portraits/class-focus-ranger.png`, `frontend/src/v03-runtime-config.js` | Gate requires `activeClass: ranger`, `activeSkin: 2`, `activeSkill: fan`, `activeGearCount >= 5`, 3 icon skill buttons, `combatFocusDisplayed`, `combatFocusStyle: hood-rifle`, `combatFocusClassId: ranger`, `combatFocusUsesSpriteAsset`, `combatFocusSkillCount: 3`, the landscape review fixed to Ranger skin 2, deterministic Guardian/Tech/Ranger class screenshots, `classShowcaseDisplayed`, 3 showcase skin swatches, 3 variant showcase skin thumbnails with 1 active thumbnail, and class-specific thumbnail styles: `shield-armor`, `coil-screen`, `hood-rifle`. |
...
| Painterly card depth layer | `frontend/engine-demo/app.js`, `frontend/engine-demo/assets/portraits/class-focus-guardian.png`, `frontend/engine-demo/assets/portraits/class-focus-tech.png`, `frontend/engine-demo/assets/portraits/class-focus-ranger.png`, `frontend/engine-demo/assets/zombies/zombie-card-brute.png`, `frontend/engine-demo/assets/zombies/zombie-card-crawler.png`, `frontend/engine-demo/assets/zombies/zombie-card-hooded.png`, `frontend/engine-demo/assets/skills/skill-card-arc.png`, `frontend/engine-demo/assets/skills/skill-card-boom.png`, `frontend/engine-demo/assets/skills/skill-card-fan.png` | Gate requires `painterlyCardCount >= 40`, `heroPainterlyCardCount >= 2`, `zombiePainterlyCardCount >= 10`, `zombiePainterlyUsesSpriteAsset`, `skillPainterlyCardCount >= 30`, `skillPainterlyUsesSpriteAsset`, `activePainterlyClass: ranger`, `activePainterlySkin: 2`, `activePainterlySkinColor: #283746`, `activePainterlyStyle: hood-rifle`, `activePainterlyUsesSpriteAsset`, plus class-review painterly style matching the class showcase styles for Guardian, Tech, and Ranger. |
