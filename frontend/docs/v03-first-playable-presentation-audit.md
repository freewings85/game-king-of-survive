...
| Clear class/skin/skill visuals | `frontend/engine-demo/app.js`, `frontend/src/v03-runtime-config.js` | Gate requires `activeClass: ranger`, `activeSkin: 2`, `activeSkill: fan`, `activeGearCount >= 5`, 3 icon skill buttons. |
