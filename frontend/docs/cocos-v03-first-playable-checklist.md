...
The checklist also requires visual contract coverage for `heroSkinSprites`, `zombieCardSprites`, and `skillCardSprites` so the Cocos slice keeps pace with the current WebGL V03 reference.
