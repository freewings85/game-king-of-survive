...
async function verifyEngineDemo(browser) {
  ...
  const info = await page.evaluate(() => ({
    ...
    zombieSpriteBodyHiddenCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieSpriteBodyHiddenCount,
    zombieSpriteBodyHiddenForAll: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieSpriteBodyHiddenForAll,
    ...
    propSpriteCoverCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.propSpriteCoverCount,
    propSpriteCoverKinds: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.propSpriteCoverKinds,
    propSpriteCoverUsesAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.propSpriteCoverUsesAsset,
    propSpriteBodyHiddenCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.propSpriteBodyHiddenCount,
    ...
    zombiePainterlyUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombiePainterlyUsesSpriteAsset,
    zombieHitFrameUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieHitFrameUsesSpriteAsset,
    zombieHitFrameSwitchCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieHitFrameSwitchCount,
    zombieWalkFrameUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieWalkFrameUsesSpriteAsset,
    zombieWalkFrameSwitchCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.zombieWalkFrameSwitchCount,
    skillPainterlyCardCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.skillPainterlyCardCount,
    skillPainterlyUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.skillPainterlyUsesSpriteAsset,
    ...
    activePainterlyUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.activePainterlyUsesSpriteAsset,
    activePainterlySkinSpriteVariant: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.activePainterlySkinSpriteVariant,
    activePainterlyUsesUnitSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.activePainterlyUsesUnitSpriteAsset,
    activePainterlyUnitFrame: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.activePainterlyUnitFrame,
    unitAnimationFrameSwitchCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.unitAnimationFrameSwitchCount,
    activePainterlyUnitSpriteVariant: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.activePainterlyUnitSpriteVariant,
    classSkinSpriteVariantCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.classSkinSpriteVariantCount,
    classUnitSpriteVariantCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.classUnitSpriteVariantCount,
    classUnitAttackSpriteVariantCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.classUnitAttackSpriteVariantCount,
    ...
    combatFocusClassId: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.combatFocusClassId,
    combatFocusSkinVariant: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.combatFocusSkinVariant,
    combatFocusUsesSpriteAsset: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.combatFocusUsesSpriteAsset,
    ...
    combatFocusRect: (() => {
      const rect = document.getElementById('combatFocus').getBoundingClientRect();
      return { width: Math.round(rect.width), height: Math.round(rect.height) };
    })(),
    classStripRect: (() => {
      const rect = document.querySelector('.class-strip').getBoundingClientRect();
      return { width: Math.round(rect.width), height: Math.round(rect.height) };
    })(),
    ...
    groundWashLayerCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.groundWashLayerCount,
    groundTileBlendCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.groundTileBlendCount,
    ...
    safeZonePainterlyLayerCount: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.safeZonePainterlyLayerCount,
    safeZonePainterlyUsesTexture: window.__V03_ENGINE_DEMO_STATE && window.__V03_ENGINE_DEMO_STATE.safeZonePainterlyUsesTexture,
  ...
  const errors = logs.filter((log) => log.type === 'pageerror' || log.type === 'error');
  if (errors.length || !info.hasWebgl || !info.hasV03Config || info.activeClass !== 'ranger' || info.activeGearClass !== 'ranger' || info.activeGearCount < 5 || info.activeSkill !== 'fan' || info.activeSkin !== 2 || info.activePainterlyClass !== 'ranger' || info.activePainterlySkin !== 2 || info.activePainterlySkinColor !== '#283746' || info.activePainterlyStyle !== 'hood-rifle' || !info.activePainterlyUsesSpriteAsset || info.activePainterlySkinSpriteVariant !== 'ranger-2' || !info.activePainterlyUsesUnitSpriteAsset || info.activePainterlyUnitSpriteVariant !== 'ranger-2' || info.classSkinSpriteVariantCount < 9 || info.classUnitSpriteVariantCount < 9 || info.classUnitAttackSpriteVariantCount < 9 || info.unitAnimationFrameSwitchCount < 2 || !info.combatFocusDisplayed || info.combatFocusStyle !== 'hood-rifle' || info.combatFocusClassId !== 'ranger' || info.combatFocusSkinVariant !== 'ranger-2' || !info.combatFocusUsesSpriteAsset || info.combatFocusSkillCount !== 3 || info.combatFocusActiveSkillCount !== 1 || info.combatFocusRect.width > 180 || info.combatFocusRect.height > 128 || info.classStripRect.width > 126 || info.classStripRect.height > 118 || info.hp <= 0 || info.shotsFired < 5 || info.damageDealt < 80 || info.kills < 1 || info.xpDropped < 1 || info.livingZombieCount < 8 || info.visibleGemCount < 8 || info.silhouettePartCount < 75 || info.zombieDetailPartCount < 285 || info.zombieVariantCount < 3 || info.zombieSpriteBodyHiddenCount < 240 || !info.zombieSpriteBodyHiddenForAll || info.unitDecalCount < 48 || info.propWearCount < 80 || info.propShapeCount < 85 || info.propBreakCount < 80 || info.propSpriteCoverCount < 18 || info.propSpriteCoverKinds < 6 || !info.propSpriteCoverUsesAsset || info.propSpriteBodyHiddenCount < 47 || info.globalLightCount < 8 || info.objectRimCount < 60 || info.materialBlendCount < 70 || info.painterlyCardCount < 40 || info.heroPainterlyCardCount < 2 || info.zombiePainterlyCardCount < 10 || !info.zombiePainterlyUsesSpriteAsset || !info.zombieHitFrameUsesSpriteAsset || info.zombieHitFrameSwitchCount < 4 || !info.zombieWalkFrameUsesSpriteAsset || info.zombieWalkFrameSwitchCount < 8 || info.skillPainterlyCardCount < 30 || !info.skillPainterlyUsesSpriteAsset || info.fxTipCount < 3 || info.fanRoundCount < 6 || info.fanTrailCount < 6 || info.fanBulletCardCount < 6 || info.fanImpactMarkCount < 3 || info.impactSparkCount < 1 || info.fxCardCount < 16 || info.groundDetailCount < 220 || info.groundWashLayerCount < 3 || info.groundTileBlendCount < 572 || !info.hasMiniMap || info.miniMapZombieDots < 3 || info.iconSkillButtons < 3 || !info.boomRingReady || !info.contractQualityOk || info.contractPropCount < 18 || info.contractTileCount < 500 || info.contractZombieEntryCount < 4 || info.contractRewardPointCount < 8 || !info.rivalVisible || !(info.safeZoneScale > 0.7 && info.safeZoneScale <= 1) || info.safeZonePainterlyLayerCount < 2 || !info.safeZonePainterlyUsesTexture) {
...
async function verifyEngineClassReview(browser, classId, skinIndex) {
  ...
  if (errors.length || !info.hasWebgl || info.activeClass !== classId || info.activeGearClass !== classId || info.activePainterlyClass !== classId || info.activeSkin !== skinIndex || info.activePainterlySkin !== skinIndex || info.activePainterlySkinColor !== info.activeSkinColor || info.activePainterlyStyle !== expectedStyle || !info.activePainterlyUsesSpriteAsset || info.activePainterlySkinSpriteVariant !== `${classId}-${skinIndex}` || !info.activePainterlyUsesUnitSpriteAsset || info.activePainterlyUnitSpriteVariant !== `${classId}-${skinIndex}` || info.classSkinSpriteVariantCount < 9 || info.classUnitSpriteVariantCount < 9 || info.classUnitAttackSpriteVariantCount < 9 || !info.activePainterlyStyleMatchesShowcase || !info.combatFocusDisplayed || info.combatFocusStyle !== expectedStyle || info.combatFocusClassId !== classId || info.combatFocusSkinVariant !== `${classId}-${skinIndex}` || !info.combatFocusUsesSpriteAsset || info.combatFocusSkillCount !== 3 || info.combatFocusActiveSkillCount !== 1 || info.activeGearCount < 3 || info.heroPainterlyCardCount < 2 || info.painterlyCardCount < 40 || !info.zombiePainterlyUsesSpriteAsset || !info.classShowcaseVisible || !info.classShowcaseDisplayed || info.classShowcaseTitle !== info.className || info.classShowcaseSkinCount !== 3 || info.classShowcaseThumbCount !== 3 || info.classShowcaseActiveThumbs !== 1 || info.classShowcaseVariantCount !== 3 || info.classShowcaseStyle !== expectedStyle || info.classShowcaseStyleCount !== 1 || info.zombieVariantCount < 3 || info.livingZombieCount < 8) {
